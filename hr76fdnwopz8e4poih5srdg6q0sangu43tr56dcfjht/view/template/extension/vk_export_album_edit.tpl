  ...
  <div class="box" id="products_table">
    ...
    <form method="post" id="form" action="">
      <table class="form">
              ...
              <tr>
                <td><?php echo $entry_export_to_album; ?> (ссылка)</td>
                <td><input type="text" name="vk_album_id" maxlength="255" size="50" value="http://vk.com/album<?php echo $album['vk_album_id']; ?>" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_owner_type; ?></td>
                <td><?php echo $album['mode_name']?></td>
              </tr>
            </table>
        </form>
    </div>
