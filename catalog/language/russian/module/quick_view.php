...
$_['text_isbn']         = 'Для этого товара предусмотрена скидка при полной предоплате. <br/><span class="help">Для уточнений конечной стоимости вы можете связаться с менеджером используя <a href="rumus.by/contacts">контактную информацию</a> или <a href="rumus.by/contact">форму для отправки email</a>.</span>';
