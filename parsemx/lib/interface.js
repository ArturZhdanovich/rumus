...
function SelectorGadget() {
  ...
  this.border_padding = 2;
    ...
    // Russian ----------------------------
     this.lang_accept = 'Готово';
     this.lang_clear = 'Очистить';
     this.lang_intro = 'Нажмите на одном из целевых елементов';
     this.lang_get = 'Добавить елемент';
     this.lang_get2 = 'Выбрать елемент';
     this.lang_skip = 'Убрать елемент';
     this.lang_fail = 'Невозможно подобрать селектор для этого елемента.';
  this.b_top = null;
  this.b_left = null;
  this.b_right = null;
  this.b_bottom = null;
...
SelectorGadget.prototype.sgMouseover = function(e) {
  ...
  if (gadget.unbound || (gadget.special_mode=='off')) return true;
...
SelectorGadget.prototype.makeInterface = function(hide) {
  ...
  this.clear_button = jQuery('<input type="button" value="'+this.lang_clear+'" style="background-color: #383838; color:white;"/>').bind("click", {'self': this}, this.clearEverything).addClass('sg_ignore');
  ...
  this.sg_div.append(jQuery('<input style="background-color: #3e71a3; font-weight: bold; color:white;" type="button" value="'+this.lang_accept+'" />').bind("click", {'self': this},
      function () {
...
if (typeof(selector_gadget) == 'undefined' || selector_gadget == null) {
  (function() {
    ...
    selector_gadget.makeInterface(rsingle && !window.top.iSelector);
